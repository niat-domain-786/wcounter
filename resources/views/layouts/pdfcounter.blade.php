...
<head>
    ...
    {{--  Social tags      --}}
    <meta name="keywords"
        content="PDF to text converter and word counter tool, free online word counter, keyword density checker tool ">

    <meta name="description"
        content="PDF to text converter, word counter and keyword density checker - free online tool">

    {{-- Twitter Card data --}}
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@wcounter">
    <meta name="twitter:title" content="PDF to text converter, and keyword density checker | free online tool">
    ...
    <meta property="article:tag" content="PDF to text converter tool">
    <meta property="article:tag" content="PDF to text converter">
    <meta property="article:tag" content="PDF to text">
    <meta property="article:tag" content="online word and character counter">
    ...
    <meta property="og:description"
        content="PDF to text converter and word counter tool to count the words, characters, characters with whitespaces, sentences, paragraphs & calculate keyword density in PDF files">
    ...
    <div class="wrappern class" id="app">
        ...
        <div class="main-panel-m ">
                    ...
                    <i class="material-icons">edit</i>
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <textarea class="form-control" style="border:1px solid #eee; padding: 0.5rem;"
                                            id="main_text" cols="30" rows="15" v-model="text_in_textarea"
                                            class="form-control" v-on:keyup="text_length" v-on:change="text_length"
                                            v-on:paste="text_length" v-on:input="text_length" v-on:click="text_length"
                           ...
                           {{-- <?php  echo "$txt"; ?> --}}
                                ...
                                <div class="card-footer ">
                                    <a rel="noopener" href="#results"
                                        class="btn btn-round btn-info"><strong>Result</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container "
                ...
                <h1 style="font-size: 2rem; padding-bottom: 2rem;">PDF to text converter tool- count Words & free
                    keyword density checker</h1>

                <div class="container">
                    <img src="https://cdn.pixabay.com/photo/2018/05/08/18/46/pdf-3383632__340.png"
                        style=" margin-right: auto; margin-left: auto; display: block;  max-width: 100%; height: auto;"
                        alt="PDF to text converter and word counter tool">
                </div>

                <h2 style="font-size: 1.7rem;">What is PDF format?</h2>


                <p>Portable Document Format (PDF) is a free file format for transferring electronic documents.
                    Adobe created the PDF file format in 1993 to display documents with text formatting and images
                    in a way that is independent of application software, hardware, and operating systems.
                    PDF-encoded documents, forms, photographs, and web pages can be viewed on any computer,
                ...
                <h2 style="font-size: 1.7rem;"><strong>
                        How do our PDF to text converter and word counter tool works?
                    </strong></h2>


                <p>The PDF to text converter and word counter tool works in a very straightforward manner. To upload,
                    all you need is a PDF file. Once the PDF file has been selected, our tool will begin uploading it
                    automatically. When the process is complete, you will be able to see the final result by counting
                    the number of words and characters. This method also extracts the plain text from your file and
                    prepares it for copying. As a result, it's a fantastic text extraction method for PDF files.</p>
                ...
                <p>Only in exceptional circumstances, the PDF to text converter and word counter tool is useful.
                    If you have a PDF file and need to retrieve all of the text quickly. If you want to measure the
                    total number of words and characters, use the tool above. If you want to figure out what will
                    be the keyword density of a focus keyword in a PDF file. This tool could fulfil the
                    above-mentioned claims. It is useful because it is easy, fast, and available on the go.</p>
