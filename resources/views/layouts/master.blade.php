...
<head>
    ...
    {{--  Social tags      --}}
    <meta name="keywords"
        content="word counter, Simple words counter, paragraph counter, character counter tool, sentecne counter, free online word counter, keyword density checker tool, characters with whitespaces counter tool ">

    <meta name="description"
        content="word counter is a free online tool to count the words, characters, characters with whitespaces & best keyword density checker tool.">

    {{-- Twitter Card data --}}
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@wcounter">
    <meta name="twitter:title"
        content="words, characters, sentences counter and keyword density checker | free online tool">
    <meta name="twitter:description"
        content="A simple online tool to count the words, characters, characters with whitespaces, sentences, paragraphs & calculates keyword density in plain english text.">

    <meta name="twitter:creator" content="@wcounter">
    <meta name="twitter:image"
        content="https://images.freeimages.com/images/small-previews/cfd/writinghand-1238351.jpg">
    ...
    <meta property="og:description"
        content="A simple online tool to count the words, characters, characters with whitespaces, sentences, paragraphs & calculate keyword density in plain english text.">
    ...
    <div class="wrappern" id="app">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="navbar-nav-scrolls">
                            <ul class="navbar-nav bd-navbar-nav flex-row ">
                                ...
                                <li class="nav-item"><a href="{{ url('pdf–to–text–converter') }}" class="nav-link">PDF
                                        to Text</a></li>
        ...
        <div class="main-panel-m ">
            ...
            <div class="content" id="results">
                <div class="content">
                    ...
                    <i class="material-icons">edit</i>
                                    ...
                                    <h3 class="card-title">Input Your Text <a href="{{url('pdf–to–text–converter')}}"
                                            target="_blank" class="btn btn-info">PDF text counter</a></h3>
                                </div>
                                <div class="card-body ">
            ...
            <div class="container "
                ...
                <p><a href="https://grammarly.com" target="_blank" rel="noreferrer">Grammar</a> plays an effective role
                ...
                <div class="container">
                    <a href="{{url('pdf–to–text–converter–and–words–counter')}}">Next Post: PDF to text converter
                        tool</a>
                </div>
