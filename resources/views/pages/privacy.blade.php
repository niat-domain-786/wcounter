...
<p>At wcounter, accessible from https://www.wcounter.net/, one of our main priorities is the privacy of our visitors.
    This Privacy Policy document contains types of information that is collected and recorded by wcounter and how we use
    it.</p>
...
<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
    the information that they shared and/or collect in wcounter. This policy is not applicable to any information
...
<h2 style="font-size: 1.4rem;">Log Files</h2>

<p>wcounter follows a standard procedure of using log files. These files log visitors when they visit websites. All
...
<h2 style="font-size: 1.4rem;">Google DoubleClick DART Cookie</h2>
...
<h2 style="font-size: 1.4rem;">Advertising Partners Privacy Policies</h2>

<P>You may consult this list to find the Privacy Policy for each of the advertising partners of wcounter.</p>

<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
    their respective advertisements and links that appear on wcounter, which are sent directly to users' browser. They
...
<p>Note that wcounter has no access to or control over these cookies that are used by third-party advertisers.</p>

<h2 style="font-size: 1.4rem;">Third Party Privacy Policies</h2>

<p>wcounter's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
...
<h2 style="font-size: 1.4rem;">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
...
<h2 style="font-size: 1.4rem;">GDPR Data Protection Rights</h2>
...
<h2 style="font-size: 1.4rem;">Children's Information</h2>
...
<p>wcounter does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
